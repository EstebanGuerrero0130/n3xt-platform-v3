...
<template>
 ...
 <div class="absolute top-40 -left-40 w-96 h-96 bg-emerald-500/5 dark:bg-emerald-500/10 rounded-[60px] blur-[120px] pointer-events-none"></div>
 ...
 :class="selections[step.id] === opt.id ? 'text-emerald-500 scale-110' : 'text-slate-400 dark:text-[#a4aea6]'"
 ...
 <p class="text-[8px] text-slate-400 dark:text-[#a4aea6] uppercase tracking-widest">{{ step.label }}</p>
 <div class="flex items-center justify-between bg-slate-50 dark:bg-black/40 p-4 rounded-[6px] border border-slate-100 dark:border-[#21262d]">

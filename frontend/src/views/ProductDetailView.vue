...
<template>
 ...
 <div>
 <div class="inline-flex items-center gap-3 px-5 py-2 bg-emerald-500/20 dark:bg-emerald-500/10 rounded-[60px] border border-emerald-500/40 dark:border-emerald-500/30 mb-8 -[0_0_25px_rgba(16,185,129,0.3)] animate-pulse hover:animate-none transition-all cursor-default">
 ...
 <!-- Specifications List -->
 <div class="grid grid-cols-2 gap-6 pt-8 border-t border-[#21262d] dark:border-[#21262d]">
 <div
v-for="spec in [
 {l: 'Tecnologia', v: 'Resina 8K / FDM Pro', c: 'text-[#8dd6ff]', i: `<svg class='w-5 h-5' fill='none' viewBox='0 0 24 24' stroke='currentColor'><path stroke-linecap='round' stroke-linejoin='round' stroke-width='2.5' d='M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z'/></svg>`},
 ...
 ]" :key="spec.l" class="group/spec flex items-center gap-5 p-5 bg-[#151a22] dark:bg-[#151a22] rounded-[2rem] border border-transparent hover:border-primary/20 transition-all duration-500">
 <div class="w-12 h-12 bg-[#151a22] dark:bg-black/40 rounded-[24px] flex items-center justify-center group-hover/spec:scale-110 group-hover/spec:bg-[#08872b]/10 transition-all" :innerHTML="sanitizeSVG(spec.i)">
 </div>
 <div>
 <p class="text-[8px] font-black text-[#c3c4c5] uppercase tracking-[0.3em] mb-1">{{ spec.l }}</p>
 ...
 <div class="space-y-3 p-6 bg-[#151a22] dark:bg-[#151a22] rounded-[2rem] border border-transparent dark:border-[#21262d]">
 <label class="text-[9px] font-black text-[#c3c4c5] dark:text-[#a4aea6] uppercase tracking-widest block ml-2">Tu Nombre (Para identificarte en WhatsApp)</label>
 <input v-model="customerForm.name" type="text" placeholder="Ej. Juan Perez..." class="w-full bg-[#151a22] dark:bg-black/40 border border-transparent dark:border-[#21262d] rounded-[24px] px-6 py-4 text-sm font-black text-[#ffffff] dark:text-white uppercase outline-none focus:ring-2 focus:ring-primary/20 transition-all">
 </div>

 <div class="flex flex-col gap-5">
 <button class="split-btn w-full px-10 py-6 bg-emerald-500 text-white rounded-[2rem] font-black text-[11px] uppercase tracking-[0.3em] -3xl -emerald-500/20 hover:scale-105 active:scale-95 transition-all flex items-center justify-center gap-4 group" @click="checkoutWhatsApp">
 ...
 <div class="p-6 bg-emerald-500/5 rounded-[24px] border border-emerald-500/10 flex items-center justify-between">
 <div class="flex items-center gap-4">
 <div class="w-10 h-10 bg-emerald-500 rounded-[6px] flex items-center justify-center text-white ">
 ...
 <div class="flex items-center gap-1.5 px-3 py-1 bg-emerald-500/20 rounded-[60px]">
 <span class="w-1.5 h-1.5 bg-emerald-500 rounded-[60px] animate-pulse"></span>
 ...
 >
 <div class="aspect-square bg-[#151a22] dark:bg-[#151a22]/50 rounded-[24px] overflow-hidden border border-[#21262d] dark:border-[#21262d] p-8 flex items-center justify-center group-hover:scale-[1.02] transition-all duration-500">

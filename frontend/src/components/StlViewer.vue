...
onMounted(async () => {
  // CAPTCHA is auto-generated by useCaptcha constructor
  await initThree()
  if (container.value) {
...
class="w-32 h-32 mx-auto mb-8 bg-white rounded-[32px] shadow-xl flex items-center justify-center transition-transform group-hover/viewer:rotate-3"
          ...
          <div v-if="!isLoading && !captchaUnlocked" class="space-y-6">
            <div class="flex items-center gap-4 bg-gray-900 p-6 rounded-[2rem] text-white border-2 border-primary/20">
              ...
              <input v-model="answer" type="number" :disabled="isLocked" class="w-20 bg-white/10 border border-white/20 rounded-xl p-3 text-center text-white font-black outline-none focus:border-primary disabled:opacity-30" @keyup.enter="verifyCaptcha">
            </div>

...
<template>
 ...
 <p class="text-[10px] font-black text-[#a4aea6] uppercase tracking-widest mt-4 ml-10">Documentación Legal Oficial N3XT 3D</p>
 </div>

 <div class="flex-1 overflow-y-auto pr-6 custom-scrollbar text-sm md:text-lg text-[#c3c4c5] font-medium leading-relaxed whitespace-pre-wrap">
 {{ legalModal.content }}
 </div>

 <div class="mt-12 pt-8 border-t border-white/5 flex justify-end">
 <button class="px-10 py-4 bg-[#08872b] text-white rounded-[24px] font-black text-[10px] uppercase tracking-widest hover:bg-emerald-600 transition-all" @click="legalModal.show = false">Entendido</button>
 </div>
 </div>
 </div>
 </transition>

<template>
 ...
 <div
 :class="[
 'relative overflow-hidden rounded-[24px] border backdrop-blur-xl p-5',
 ...
 <div class="absolute bottom-0 left-0 right-0 h-1 bg-[#151a22]/10">
 <div class="h-full bg-[#151a22]/30 animate-shrink-bar" style="animation-duration: 4s"></div>
 </div>
 </div>
 </div>
 ...
 <div class="relative bg-[#151a22] border border-gray-700 rounded-[24px] max-w-md w-full p-8 text-center">
 ...
 <p class="text-[#c3c4c5] text-sm mb-8 leading-relaxed">{{ props.confirmDialog.message }}</p>
 <div class="flex gap-4 justify-center">
 <button
 v-if="props.confirmDialog.mode === 'confirm'"
 class="px-6 py-3 rounded-[6px] bg-[#283041] hover:bg-gray-700 text-gray-300 font-semibold transition-all text-sm"
 @click="handleCancel"
 >
 Cancelar
 </button>
 <button
 :class="[
 'px-6 py-3 rounded-[6px] font-bold transition-all text-sm',

...
v-for="colIdx in 6" :key="'skel-col-'+colIdx" 
 ...
 <div class="flex items-center justify-between mb-6 px-6 py-4 bg-[#151a22] dark:bg-[#151a22] rounded-[24px]">
 <div class="flex items-center gap-4">
 <div class="w-4 h-4 rounded-[60px] bg-gray-200 dark:bg-[#2a3040]"></div>
 <div class="h-3 w-24 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="h-6 w-8 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 
 <!-- Cards Skeleton -->
 <div class="flex-1 bg-[#151a22]/30 dark:bg-[#151a22]/5 rounded-[24px] p-5 space-y-6 border-2 border-dashed border-[#21262d]/50 dark:border-[#21262d]">
 <div
v-for="cardIdx in (colIdx < 2 ? 3 : 2)" :key="'skel-card-'+colIdx+'-'+cardIdx" 
 class="bg-[#151a22] dark:bg-[#151a22] rounded-[28px] p-6 border border-[#21262d] dark:border-[#21262d] space-y-4"
 >
 <div class="flex justify-between items-start">
 <div class="space-y-2 flex-1">
 <div class="h-4 w-3/4 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-3 w-1/2 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="h-8 w-8 bg-gray-200 dark:bg-[#2a3040] rounded-[6px]"></div>
 </div>
 <div class="flex gap-2">
 <div class="h-5 w-16 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-5 w-20 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="flex justify-between items-center pt-2 border-t border-[#21262d] dark:border-[#21262d]">
 <div class="h-4 w-16 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-4 w-12 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 </div>
 </div>
 </div>
 ...
 <button 
 class="absolute left-1 top-1/2 -translate-y-1/2 z-10 w-12 h-12 md:w-14 md:h-14 bg-[#151a22] dark:bg-[#151a22] rounded-[60px] flex items-center justify-center text-[#c3c4c5] dark:text-[#a4aea6] hover:text-[#8dd6ff] transition-all duration-300 opacity-100 md:opacity-0 md:group-hover/kanban:opacity-100 border border-[#21262d] dark:border-[#21262d]"
 @click="scroll(-1)"
 >
 ...
 <button 
 class="absolute right-1 top-1/2 -translate-y-1/2 z-10 w-12 h-12 md:w-14 md:h-14 bg-[#151a22] dark:bg-[#151a22] rounded-[60px] flex items-center justify-center text-[#c3c4c5] dark:text-[#a4aea6] hover:text-[#8dd6ff] transition-all duration-300 opacity-100 md:opacity-0 md:group-hover/kanban:opacity-100 border border-[#21262d] dark:border-[#21262d]"
 @click="scroll(1)"
 >

...
<template>
 ...
 <div class="bg-[#151a22] dark:bg-[#151a22] rounded-[2.5rem] w-full max-w-lg overflow-hidden animate-in zoom-in duration-300 my-auto">
 <div class="p-6 md:p-10 max-h-[90vh] overflow-y-auto no-scrollbar">
 <div class="flex justify-between items-center mb-6 md:mb-8">
 <h3 class="text-xl md:text-2xl font-black text-[#ffffff] dark:text-white uppercase tracking-tighter">Editar Ítem</h3>
 ...
 <input v-model="form.name" type="text" class="w-full bg-[#151a22] dark:bg-[#151a22]/5 border border-[#21262d] dark:border-[#21262d] rounded-[24px] px-6 py-4 text-sm font-bold text-[#ffffff] dark:text-white focus:ring-2 focus:ring-primary outline-none transition-all">
 </div>

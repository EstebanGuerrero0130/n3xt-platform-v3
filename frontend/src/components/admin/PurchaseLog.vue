...
<template>
 ...
 <div class="space-y-3">
 <div class="h-10 w-64 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-4 w-48 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 ...
 <div v-for="i in 4" :key="'kpi-'+i" class="bg-[#151a22] dark:bg-[#151a22] p-6 md:p-8 rounded-[24px] md:rounded-[2.5rem] border border-[#21262d]/50 dark:border-[#21262d]">
 <div class="h-3 w-24 bg-gray-200 dark:bg-[#2a3040] rounded-[60px] mx-auto mb-4"></div>
 <div class="h-8 w-32 bg-gray-200 dark:bg-[#2a3040] rounded-[60px] mx-auto"></div>
 </div>
 </div>
 ...
 <div v-for="i in 6" :key="'card-'+i" class="bg-[#151a22] dark:bg-[#151a22] rounded-[2.5rem] border border-[#21262d]/50 dark:border-[#21262d] p-8 space-y-6">
 <div class="flex justify-between items-start">
 <div class="space-y-2">
 <div class="h-3 w-28 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-5 w-16 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="h-10 w-10 bg-gray-200 dark:bg-[#2a3040] rounded-[24px]"></div>
 </div>
 <div class="h-6 w-3/4 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="flex items-center gap-2">
 <div class="h-5 w-5 bg-gray-200 dark:bg-[#2a3040] rounded-[6px]"></div>
 <div class="h-3 w-32 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="bg-gray-200/50 dark:bg-[#1a1f2e] rounded-[24px] p-4 flex justify-between">
 <div class="space-y-2">
 <div class="h-2 w-16 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-4 w-20 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="space-y-2 text-right">
 <div class="h-2 w-16 bg-gray-200 dark:bg-[#2a3040] rounded-[60px] ml-auto"></div>
 <div class="h-4 w-20 bg-gray-200 dark:bg-[#2a3040] rounded-[60px] ml-auto"></div>
 </div>
 </div>
 <div class="flex justify-between items-end pt-2">
 <div class="space-y-2">
 <div class="h-2 w-16 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 <div class="h-7 w-24 bg-gray-200 dark:bg-[#2a3040] rounded-[60px]"></div>
 </div>
 <div class="h-12 w-12 bg-gray-200 dark:bg-[#2a3040] rounded-[24px]"></div>
 </div>
 </div>
 </div>
 </div>
 ...
 <div class="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-6 mb-8 px-4">
 <div>
 <h2 class="text-3xl md:text-5xl font-black text-[#ffffff] dark:text-white tracking-tighter uppercase mb-2">Registro de Compras</h2>
 <div class="flex items-center gap-3">
 <div class="w-2 h-2 rounded-[60px] bg-[#08872b] animate-pulse"></div>
 <p class="text-[#c3c4c5] dark:text-[#a4aea6] font-bold uppercase tracking-widest text-[10px] md:text-[10px]">Trazabilidad financiera y operativa</p>
 </div>
 </div>
 
 <!-- Filtros y Botones -->
 <div class="flex flex-col sm:flex-row flex-wrap items-center gap-4 bg-[#151a22] dark:bg-[#151a22] p-3 md:p-4 rounded-[24px] md:rounded-[2rem] border border-[#21262d] dark:border-[#21262d] w-full xl:w-auto">
 <div class="flex items-center gap-2 px-4 border-b sm:border-b-0 sm:border-r border-[#21262d] dark:border-[#21262d] w-full sm:w-auto pb-2 sm:pb-0">
 <label class="text-[10px] font-black text-[#c3c4c5] dark:text-[#a4aea6] uppercase">Desde</label>
 <input v-model="dateFilter.start" type="date" class="bg-transparent border-none text-xs font-bold text-[#ffffff] dark:text-white outline-none flex-1">
 </div>
 <div class="flex items-center gap-2 px-4 border-b sm:border-b-0 sm:border-r border-[#21262d] dark:border-[#21262d] w-full sm:w-auto pb-2 sm:pb-0">
 <label class="text-[10px] font-black text-[#c3c4c5] dark:text-[#a4aea6] uppercase">Hasta</label>
 <input v-model="dateFilter.end" type="date" class="bg-transparent border-none text-xs font-bold text-[#ffffff] dark:text-white outline-none flex-1">
 </div>
 <div class="flex gap-2 w-full sm:w-auto">
 <button class="flex-1 sm:flex-none p-4 bg-[#151a22] dark:bg-[#151a22]/5 text-[#a4aea6] dark:text-[#c3c4c5] rounded-[6px] md:rounded-[24px] hover:bg-[#151a22] dark:hover:bg-[#151a22]/10 transition-all flex items-center justify-center gap-2" @click="generatePDFReport">
 <span class="text-[10px] font-black uppercase tracking-widest">PDF</span>
 <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
 </button>
 <button class="flex-[2] sm:flex-none px-6 md:px-8 py-4 bg-[#151a22] dark:bg-[#08872b] text-white rounded-[6px] md:rounded-[24px] -black/10 hover:bg-[#08872b] dark:hover:bg-[#151a22] dark:hover:text-[#8dd6ff] transition-all active:scale-95 flex items-center justify-center gap-3 font-black text-[10px] uppercase tracking-widest" @click="showNewPurchaseModal = true">
 ...
 <h3 class="text-2xl md:text-4xl font-black text-[#ffffff] dark:text-white tracking-tighter text-center">{{ stats.count }}</h3>
 </div>
 </div>
...
v-for="p in filteredPurchases" :key="p.id" 
 class="group relative bg-[#151a22] dark:bg-[#151a22] rounded-[2.5rem] border border-[#21262d] dark:border-[#21262d] p-8 dark:-none hover: hover:-gray-200/50 dark:hover:border-primary/20 transition-all duration-500 hover:-translate-y-1 overflow-hidden">
 
 <!-- Decoración de Fondo -->
 <div class="absolute -right-4 -top-4 w-24 h-24 bg-[#151a22] dark:bg-[#151a22]/5 rounded-[60px] opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
 
 <!-- Badge de Fecha y Categoría -->
 <div class="flex justify-between items-start mb-6 relative z-10">
 <div class="flex flex-col gap-1">
 <span class="text-[10px] font-black text-[#c3c4c5] dark:text-[#a4aea6] uppercase tracking-[0.2em]">{{ new Date(p.purchase_date).toLocaleDateString(undefined, { day: 'numeric', month: 'short', year: 'numeric' }) }}</span>
 <div
:class="[
 'px-3 py-1 rounded-[60px] text-[8px] font-black uppercase tracking-widest border inline-block',
 ...
 <button 
 :class="[
 'w-10 h-10 rounded-[24px] transition-all flex items-center justify-center ',
 confirmingDeleteId === p.id ? 'bg-rose-600 text-white animate-pulse scale-110' : 'bg-[#151a22] text-gray-300 hover:bg-rose-50 hover:text-rose-500'
 ]" 
 ...
 <h4 class="text-lg font-black text-[#ffffff] dark:text-white leading-tight uppercase tracking-tighter group-hover:text-[#8dd6ff] transition-colors">{{ p.item_name }}</h4>
 <div class="flex items-center gap-2">
 <div class="w-5 h-5 rounded-[6px] bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center text-[10px] font-black text-indigo-500">P</div>
 <span class="text-[10px] font-bold text-[#c3c4c5] dark:text-[#a4aea6] uppercase tracking-widest">{{ p.supplier || 'Proveedor Eventual' }}</span>
 </div>
 </div>

 <!-- Detalles de Cantidad -->
 <div class="bg-[#151a22]/50 dark:bg-[#151a22]/5 rounded-[24px] p-4 flex justify-between items-center mb-6 border border-[#21262d]/50 dark:border-[#21262d]">
 ...
 <!-- Empty State -->
 <div v-else class="py-32 flex flex-col items-center justify-center bg-[#151a22]/50 rounded-[3rem] border border-dashed border-[#21262d]">
 ...
 <p class="text-[#c3c4c5] font-black uppercase tracking-[0.3em] text-xs">Sin registros en este periodo</p>
 </div>
 </div>

 <div v-if="showNewPurchaseModal" class="fixed inset-0 bg-[#090d0a]/60 backdrop-blur-md z-[100] flex items-center justify-center p-0 md:p-4 overflow-y-auto no-scrollbar">
 <div class="bg-[#151a22] md:rounded-[3rem] w-full max-w-4xl overflow-hidden animate-in zoom-in duration-500 my-auto border border-white/20">
 ...
 <div class="w-16 h-16 bg-[#151a22] rounded-[1.5rem] flex items-center justify-center -black/20 transform -rotate-6"><svg class="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg></div>
 <div>
 <h3 class="text-3xl md:text-4xl font-black text-[#ffffff] uppercase tracking-tighter leading-none">Registrar Compra</h3>
 <p class="text-[10px] md:text-xs text-[#c3c4c5] font-bold uppercase tracking-widest mt-2 flex items-center gap-2">
 <span class="w-2 h-2 rounded-[60px] bg-[#08872b] animate-pulse"></span>
 Auditoría de Insumos y Suministros
 </p>
 </div>
 </div>
 <button class="w-12 h-12 bg-[#151a22] text-[#c3c4c5] rounded-[24px] flex items-center justify-center hover:bg-[#151a22] hover:text-white transition-all duration-500 " @click="showNewPurchaseModal = false">
 ...
 <div class="bg-[#151a22]/50 p-8 rounded-[2.5rem] border border-[#21262d] space-y-6">
 <div class="space-y-3">
 <label class="text-[10px] font-black text-[#c3c4c5] uppercase tracking-widest flex items-center gap-2">
 Categoria de Gasto
 </label>
 <select v-model="newPurchase.category" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-5 font-black text-xs text-[#ffffff] outline-none focus:ring-4 focus:ring-primary/10 transition-all ">
 ...
 <div v-if="newPurchase.category === 'inventory_restock'" class="pt-4 border-t border-[#21262d] space-y-6">
 <div class="flex items-center justify-between">
 <label class="text-[10px] font-black text-[#8dd6ff] uppercase tracking-widest">Vincular Item</label>
 <button class="text-[8px] font-black uppercase tracking-widest px-4 py-2 bg-[#151a22] border border-primary/20 rounded-[60px] text-[#8dd6ff] hover:bg-[#08872b] hover:text-white transition-all " @click="isNewMaterial = !isNewMaterial">
 {{ isNewMaterial ? 'Seleccionar Existente' : 'Nuevo Material' }}
 </button>
 </div>

 <div v-if="!isNewMaterial" class="animate-in fade-in slide-in-from-left-4">
 <select v-model="newPurchase.material_id" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-5 font-black text-xs text-[#ffffff] outline-none focus:ring-4 focus:ring-primary/10">
 ...
 type="button"
 :class="[
 'py-3 rounded-[6px] text-[8px] font-black uppercase transition-all border',
 newPurchase.material_data.type === 'material' ? 'bg-[#08872b] text-white border-primary ' : 'bg-[#151a22] text-[#c3c4c5] border-[#21262d] hover:bg-[#151a22]'
 ]"
 @click="() => {
 ...
 :class="[
 'py-3 rounded-[6px] text-[8px] font-black uppercase transition-all border',
 newPurchase.material_data.type === 'product' ? 'bg-indigo-600 text-white border-indigo-600 ' : 'bg-[#151a22] text-[#c3c4c5] border-[#21262d] hover:bg-[#151a22]'
 ]"
 @click="() => {
 ...
 :class="[
 'py-3 rounded-[6px] text-[8px] font-black uppercase transition-all border',
 newPurchase.material_data.type === 'utility' ? 'bg-amber-500 text-white border-amber-500 ' : 'bg-[#151a22] text-[#c3c4c5] border-[#21262d] hover:bg-[#151a22]'
 ]"
 @click="() => {
 ...
 <label class="text-[10px] font-black text-[#c3c4c5] uppercase ml-2">Tecnología</label>
 <select v-model="newPurchase.material_data.category" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-4 font-black text-[10px] text-[#ffffff] outline-none uppercase" @change="newPurchase.material_data.unit = newPurchase.material_data.category === 'SLA' ? 'ml' : 'g'">
 ...
 <label class="text-[10px] font-black text-[#c3c4c5] uppercase ml-2">Unidad de Medida</label>
 <select v-model="newPurchase.material_data.unit" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-4 font-black text-[10px] text-[#ffffff] outline-none uppercase">
 ...
 <div class="space-y-2">
 <label class="text-[10px] font-black text-[#c3c4c5] uppercase ml-2">Nombre Identificador</label>
 <input v-model="newPurchase.material_data.name" type="text" placeholder="Ej: PLA Pro Negro" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-5 font-black text-xs text-[#ffffff] outline-none focus:ring-4 focus:ring-primary/10">
 </div>

 <div class="flex items-center gap-4 bg-[#151a22]/50 p-4 rounded-[24px] border border-dashed border-[#21262d]">
 <div class="flex items-center gap-2 flex-1">
 <input v-model="newPurchase.material_data.color" type="color" class="w-8 h-8 rounded-[6px] border-none bg-transparent cursor-pointer">
 <span class="text-[10px] font-black text-[#c3c4c5] uppercase">Visual</span>
 </div>
 <div class="text-right">
 <span class="text-[8px] font-black text-gray-300 uppercase block">ID Sugerido</span>
 <span class="text-[10px] font-black text-[#c3c4c5] italic font-mono">{{ newPurchase.material_data.id || '---' }}</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <input v-model="newPurchase.item_name" type="text" placeholder="Ej: Correa GT2 6mm" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-5 font-bold text-sm text-[#ffffff] outline-none focus:ring-4 focus:ring-primary/10">
 </div>
 </div>
 ...
 <select class="w-full bg-[#151a22] border border-indigo-100 rounded-[24px] p-4 font-black text-xs text-[#ffffff] outline-none " @change="handleSelectSupplier">
 <option value="">-- Nuevo Proveedor --</option>
 <option v-for="s in suppliers" :key="s.id" :value="s.name">{{ s.name }}</option>
 </select>
 <input v-model="newPurchase.supplier" type="text" placeholder="Nombre Comercial" class="w-full bg-[#151a22] border border-indigo-100 rounded-[24px] p-4 font-bold text-xs text-[#ffffff] outline-none ">
 </div>
 </div>
 </div>
 ...
 <div class="grid grid-cols-2 gap-6 bg-[#151a22] p-8 rounded-[3rem] -black/20 relative overflow-hidden">
 <!-- Cantidades -->
 <div class="space-y-3 relative z-10">
 <label class="text-[10px] font-black text-[#c3c4c5] uppercase tracking-widest">Nº Unidades</label>
 <input v-model.number="newPurchase.units" type="number" class="w-full bg-[#151a22]/10 border border-white/10 rounded-[24px] p-5 font-black text-2xl text-white outline-none focus:ring-4 focus:ring-primary/30">
 </div>
 <div class="space-y-3 relative z-10">
 <label class="text-[10px] font-black text-[#c3c4c5] uppercase tracking-widest">Contenido Unit.</label>
 <input v-model.number="newPurchase.unit_amount" type="number" class="w-full bg-[#151a22]/10 border border-white/10 rounded-[24px] p-5 font-black text-2xl text-white outline-none focus:ring-4 focus:ring-primary/30">
 </div>
 ...
 <input v-model.number="newPurchase.total_cost" type="number" class="w-full bg-emerald-500/10 border border-emerald-500/20 rounded-[24px] p-6 font-black text-4xl text-emerald-400 outline-none focus:ring-4 focus:ring-emerald-500/20">
 </div>
 </div>
 ...
 <div v-if="newPurchase.total_cost > 0 && (newPurchase.units * newPurchase.unit_amount) > 0" class="bg-emerald-50 p-8 rounded-[2.5rem] border border-emerald-100 flex flex-col md:flex-row justify-between items-center gap-6 animate-in zoom-in duration-500 -emerald-500/5">
 ...
 <input v-model="newPurchase.purchase_date" type="date" class="w-full bg-[#151a22] border border-[#21262d] rounded-[24px] p-5 font-black text-sm text-[#ffffff] outline-none focus:ring-4 focus:ring-primary/10">
 </div>
 </div>
 </div>
 ...
 <button class="flex-1 py-6 bg-[#151a22] text-[#c3c4c5] rounded-[2rem] font-black text-xs uppercase tracking-widest hover:bg-gray-200 hover:text-[#a4aea6] transition-all duration-500 flex items-center justify-center gap-3" @click="showNewPurchaseModal = false">
 SALIR SIN REGISTRAR
 </button>
 <button class="flex-[2] py-6 bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] -black/30 hover:scale-[1.02] hover:-primary/20 active:scale-95 transition-all duration-500 flex items-center justify-center gap-4" @click="handleAddPurchase">
